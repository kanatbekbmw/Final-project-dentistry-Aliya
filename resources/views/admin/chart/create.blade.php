    ...
    <div class="content-wrapper">
        ...
        <table class="table table-striped">
            ...
            <div class="card-body mt-3">
                <form method="POST" action="{{ route('admin-store-chart') }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control @error('time') is-invalid @enderror" name="time" required autocomplete="time" autofocus>
